...
public class ProfilingActivity extends Activity {
    ...
    public class MySimpleArrayAdapter extends ArrayAdapter<Boolean> {
        ...
        private final String[] player_names = { "Player 1 (Male)", "Player 2 (Male)", "Player 3 (Male)",
                "Player 4 (Male)", "Player 5 (Female)", "Player 6 (Female)", "Player 7 (Female)",
                "Player 8 (Female)"};
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	    	...
	    	View rowView = inflater.inflate(R.layout.profiling_item_simple, parent, false);
	    	TextView textView = (TextView) rowView.findViewById(R.id.profiling_label);
	    	ImageView imageView = (ImageView) rowView.findViewById(R.id.profiling_image);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Boolean [] OKs = {false,false,false,false,false,false,false,false};		
        MySimpleArrayAdapter adapter = new MySimpleArrayAdapter(paintFrame.getContext(),OKs);
        	...
        	for (int location = 0; location < 8; location++)
        	{
    			...
    			try {
    				player = profiled.getJSONObject(location);
    				 ...
    				 Log.i("paint", "i " + i + ",state " + profileState);
